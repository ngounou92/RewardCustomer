            ...
            if (data.error) {
                ...
                $('.points-allocated-transactions').html(function() {
                    ...
                    for (let i = 0; i < transactionData.length; i++) {
                        str = str + '<p>timeStamp: ' + transactionData[i].timestamp + '<br />company: ' + transactionData[i].partner + '<br />customer: ' + transactionData[i].member + '<br />points: ' + transactionData[i].points + '<br />transactionID: ' + transactionData[i].transactionId + '</p><br>';
                    }
                    return str;
                });
